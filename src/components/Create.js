...
export default function Create() {
  ...
  const handleSubmit = (e) => {
    ...
    if (age === "") {
      ...
      const entered_year = parseInt(new Date(date.valueOf()).getFullYear(), 10);
      const now_year = parseInt(new Date().getFullYear(), 10);

      if (now_year - entered_year !== parseInt(age, 10)) {
        Swal.fire({
          icon: "error",
          title: "Oops...",
